...
const Timeline = () => {
  ...
  return (
    ...
    <Section id="about">
      ...
      <SectionText>
        I'm passionate about Deep Learning because of the future real world implications it could have. I want to solve real problems that society is facing today using deep learning.
      </SectionText>
